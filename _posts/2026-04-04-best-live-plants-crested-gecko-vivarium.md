---
layout: post
title: "Best Live Plants for a Crested Gecko Vivarium"
description: "The best live plants for a crested gecko vivarium - which species thrive, which are toxic to avoid, and how to plant and maintain a naturalistic setup."
date: 2026-04-04
image: /assets/images/2026-04-04-best-live-plants-crested-gecko-vivarium.jpg
---
...
![Lush green monstera leaves with a large fenestrated leaf in sharp focus](/assets/images/2026-04-04-best-live-plants-crested-gecko-vivarium.jpg)

<p class="image-credit">Photo by <a href="https://unsplash.com/@krystianb?utm_source=artlines_blog&utm_medium=referral">Krystian Bęben</a> on <a href="https://unsplash.com/?utm_source=artlines_blog&utm_medium=referral">Unsplash</a></p>
...
If you're interested in going fully bioactive, check out our [bioactive crested gecko enclosure guide](/bioactive-crested-gecko-enclosure) for the full drainage-layer and substrate breakdown.
...
The [ASPCA's toxic plant database](https://www.aspca.org/pet-care/animal-poison-control/toxic-and-non-toxic-plants) is a reliable first reference, though it's primarily compiled for cats and dogs. Cross-reference with reptile keeper community resources like the Josh's Frogs plant safety guide before making final selections.
...
Getting plants to establish successfully is mostly a matter of preparation. The substrate and drainage layer need to be set up correctly before planting - if water pools in the root zone, plants will rot regardless of species. Our [substrate guide for crested gecko enclosures](/best-substrates-crested-gecko-enclosures) covers the drainage layer setup in detail, but the short version is: use a 2-3 inch layer of drainage medium (hydroballs or lava rock) below your organic substrate layer.
...
For more on building the underlying structure of a bioactive vivarium, read our [bioactive crested gecko enclosure guide](/bioactive-crested-gecko-enclosure). If you're working through the full humidity and temperature picture for your setup, the [crested gecko temperature and humidity care guide](/crested-gecko-temperature-and-humidity-complete-care-guide) covers the environmental targets in detail.
